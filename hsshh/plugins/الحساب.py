...
from hsshh.utils import admin_cmd, sudo_cmd, eor
...
from hsshh.utils.decorators import register
from ..helpers.utils import reply_id, _catutils, parse_pre, yaml_format, install_pip, get_user_from_event, _format
from hsshh.helpers.functions import convert_toimage,    deEmojify,    phcomment,    threats,    trap,    trash
from hsshh.helpers.functions import convert_tosticker,    flip_image,    grayscale,    invert_colors,    mirror_file,    solarize
...
from PIL import Image, ImageDraw, ImageFont
import PIL.ImageOps
from . import AUTONAME, BOTLOG, BOTLOG_CHATID, DEFAULT_BIO, _catutils, edit_delete, hsshh, logging, spamwatch    
...
autopic_path = os.path.join(os.getcwd(), "hsshh", "original_pic.png")
digitalpic_path = os.path.join(os.getcwd(), "hsshh", "digital_pic.png")
autophoto_path = os.path.join(os.getcwd(), "hsshh", "photo_pfp.png")
...
DEFAULTUSERBIO = gvarstatus("DEFAULT_BIO") or "@hsshh"
...
async def crop(imagefile, endname, x):
    ...
    inverted_image.save(endname)
@hsshh.on(admin_cmd(pattern="احصائيات حسابي(?: |$)(.*)"))
...
@hsshh.on(admin_cmd(outgoing=True, pattern="ص1$"))
async def iqvois(vois):
    ...
    if iqvois1:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص2$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois2:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص3$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois3:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="اطار ?(.*)"))
async def memes(mafia):
    ...
    for files in (mafiasticker, meme_file):
        if files and os.path.exists(files):
            os.remove(files)
@hsshh.on(admin_cmd(outgoing=True, pattern="ص4$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois4:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="قلب الصوره$"))
async def memes(mafia):
    reply = await mafia.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(mafia, "الرد على الوسائط المدعومة")
...
@hsshh.on(admin_cmd(outgoing=True, pattern="فلتر رصاصي$"))
async def memes(mafia):
    reply = await mafia.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(mafia, "الرد على الوسائط المدعومة")
...
@hsshh.on(admin_cmd(outgoing=True, pattern="زوم ?(.*)"))
async def memes(mafia):
    reply = await mafia.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(mafia, "الرد على الوسائط المدعومة")
    ...
    for files in (mafiasticker, meme_file):
        if files and os.path.exists(files):
            os.remove(files)
@hsshh.on(admin_cmd(outgoing=True, pattern="ص5$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois5:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص6$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois6:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص7$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois7:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص8$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص9$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
...
@hsshh.on(admin_cmd(outgoing=True, pattern="ص10$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois10:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص11$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois11 :
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص12$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois12:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص13$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois13:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص14$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois14:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص15$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois15:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص16$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois16:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص17$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois17:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص18$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois18:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص19$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois19:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص20$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois20:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص21$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois21:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص22$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois22:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص23$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois23:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص24$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois24:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص25$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois25:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص26$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois26:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص27$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois27:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص28$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois28:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص29$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois29:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص30$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois30:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص31$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois31:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص32$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois32:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص33$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois33:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص34$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois34:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص35$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois35:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص36$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois36:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص37$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois37:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص38$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois38:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص39$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois39:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص40$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois40:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص41$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois41:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص42$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois42:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص43$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois43:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص44$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois44:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص45$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois45:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص46$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois46:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص47$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois47:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص48$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois48:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص49$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois49:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص50$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois50:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(pattern="قائمه (جميع القنوات|قنوات اديرها|قنوات امتلكها)$"))
async def stats(event):  
    ...
    try:
        ...
        await edit_or_reply(            catevent,
            output,
            caption=caption        )
@hsshh.on(admin_cmd(pattern="قائمه (جميع المجموعات|مجموعات اديرها|مجموعات امتلكها)$"))
async def stats(event):  
    catcmd = event.pattern_match.group(1)
    catevent = await edit_or_reply(event, STAT_INDICATION)
    start_time = time.time()
    ...
    try:
        ...
        await edit_or_reply(
            ...
            output,
            caption=caption        )
@hsshh.iq_cmd(pattern="حفض كتابه$")
async def saf(e):
...
@hsshh.iq_cmd(pattern="حفض توجيه$")
async def saf(e):
    x = await e.get_reply_message()
    if not x:
        return await eod(            e, "قم بالرد على أي رسالة لحفظها في رسائلك المحفوظة", time=5        )
    ...
    await eor(e, "تم حفظ الرسالة.", time=5)
@hsshh.on(admin_cmd(pattern="(الايدي|id)(?: |$)(.*)"))
async def _(event):
...
@hsshh.on(admin_cmd(pattern="وضع بايو(?: |$)(.*)"))
async def _(event):
...
@hsshh.on(admin_cmd(pattern="وضع اسم(?: |$)(.*)"))
async def _(event):
    ...
    try:
        ...
        await edit_or_reply(event, f"**♛ ⦙  خطأ  ⚠️ :**\n`{str(e)}`")
@hsshh.on(admin_cmd(pattern="وضع صوره(?: |$)(.*)"))
async def _(event):
    ...
    try:
        ...
        if photo:
            await catevent.edit("**♛ ⦙   أشترك @hsshh **")
...
async def digitalpicloop():
    ...
    while DIGITALPICSTART:
        ...
        file = await hsshh.upload_file(autophoto_path)
        try:
            if i > 0:
                await hsshh(                    functions.photos.DeletePhotosRequest(                        await hsshh.get_profile_photos("me", limit=1)                   )                )
            i += 1
            await hsshh(functions.photos.UploadProfilePhotoRequest(file))
            os.remove(autophoto_path)
            await asyncio.sleep(60)
        except BaseException:
            return
        DIGITALPICSTART = gvarstatus("صوره وقتيه") == "true"
@hsshh.on(admin_cmd(pattern="وضع معرف(?: |$)(.*)"))
async def update_username(username):
    ...
    try:
        ...
        await edit_or_reply(event, f"**♛ ⦙  خطأ  ⚠️ :**\n`{str(e)}`")
@hsshh.on(admin_cmd(pattern=r"شوت ?(.*)", outgoing=True))
...
if 1 == 1:
    ...
    @hsshh.on(admin_cmd(pattern="الصور ?(.*)"))
    async def potocmd(event):
        ...
        if id.strip() == "":
            ...
            if int(id) <= (len(photos)):
                ...
                return
@hsshh.on(admin_cmd(pattern="معرفاتي(?: |$)(.*)"))
async def _(event):
...
@hsshh.on(admin_cmd(pattern="ملكيه ([\s\S]*)"))
async def _(event):
...
@hsshh.on(admin_cmd(pattern=f"{plagiarism}(?: |$)(.*)"))
async def _(event):
...
async def autobio_loop():
    ...
    while AUTOBIOSTART:
        ...
        LOGS.info(bio)
        try:
            await hsshh(functions.account.UpdateProfileRequest(about=bio))
        except FloodWaitError as ex:
            LOGS.warning(str(ex))
            await asyncio.sleep(ex.seconds)
        await asyncio.sleep(Config.CHANGE_TIME)
        AUTOBIOSTART = gvarstatus(f"{OR_AUTOBIO}") == "true"
@hsshh.on(admin_cmd(pattern=f"{unplagiarism}(?: |$)(.*)"))
async def _(event):
    name = f"{DEFAULTUSER}"
    blank = ""
...
async def autoname_loop():
    ...
    while AUTONAMESTART:
        ...
        LOGS.info(name)
        try:
            await hsshh(functions.account.UpdateProfileRequest(first_name=name))
        except FloodWaitError as ex:
            LOGS.warning(str(ex))
            await asyncio.sleep(ex.seconds)
        await asyncio.sleep(Config.CHANGE_TIME)
        AUTONAMESTART = gvarstatus(f"{OR_NAMEAUTO}") == "true"
@hsshh.on(admin_cmd(pattern="كشف(?:\s|$)([\s\S]*)"))
async def _(event):
    replied_user, error_i_a = await get_user_from_event(event)
    if not replied_user:
        return
...
@hsshh.on(admin_cmd(pattern=f"{idee}(?:\s|$)([\s\S]*)"))
async def who(event):
    if not os.path.isdir(Config.TMP_DOWNLOAD_DIRECTORY):
        os.makedirs(Config.TMP_DOWNLOAD_DIRECTORY)
...
@hsshh.on(admin_cmd(pattern="رابطه(?:\s|$)([\s\S]*)"))
...
@hsshh.on(admin_cmd(pattern="اسمه(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    user, custom = await get_user_from_event(mention)
    if not user:
        return
...
@hsshh.on(admin_cmd(pattern="صورته(?:\s|$)([\s\S]*)"))
async def potocmd(event):
    ...
    if uid.strip() == "":
        ...
        await event.client.send_file(event.chat_id, send_photos)
    await event.delete()  
@hsshh.on(admin_cmd(pattern=f"{OR_FOTOAUTO}(?: |$)(.*)"))
async def _(event):
    downloader = SmartDL(digitalpfp, digitalpic_path, progress_bar=False)
    downloader.start(blocking=False)
    while not downloader.isFinished():
...
@hsshh.on(admin_cmd(pattern="الملفات ?(.*)"))
async def _(e):
    ...
    try:
        ...
        await e.delete()
@hsshh.on(admin_cmd(pattern="كول (.*)"))
async def _(event):
...
@hsshh.on(admin_cmd(pattern="كتابه ?(.*)"))
async def writer(e):
    if e.reply_to:
    ...
    for line in lines:
        ...
        y = y + line_height - 5
    file = "hsshh_Write.jpg"
    img.save(file)
    await e.reply(file=file)
    os.remove(file)
    await e.delete()
@hsshh.on(admin_cmd(pattern="عد الردود ?(.*)"))
async def _(event):
...
@hsshh.on(admin_cmd(pattern="زاجل ?(.*)"))
...
@hsshh.on(admin_cmd(pattern=f"{OR_NAMEAUTO}(?: |$)(.*)"))
async def _(event):
    ...
    await autoname_loop()
@hsshh.on(admin_cmd(pattern=f"{OR_AUTOBIO}(?: |$)(.*)"))
async def _(event):
    ...
    await autobio_loop()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص51$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois51:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص52$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois52:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص55$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois55:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص54$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois54:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص56$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois56:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص53$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois53:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص57$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois57:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص58$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois58:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص59$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
...
async def ultiny(event):
    ...
    os.remove(file)
    os.remove(ik)
@hsshh.on(admin_cmd(outgoing=True, pattern="ص60$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois60:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص61$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois61:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص62$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois62:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص63$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois63:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص64$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois64:
        ...
        await vois.delete()
@hsshh.on(events.NewMessage(outgoing=True, pattern="^.ارسل ?(.*)"))
...
@hsshh.on(admin_cmd(outgoing=True, pattern="ص65$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois65:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص66$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois66:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص67$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois67:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص68$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois68:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص69$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois69:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص70$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois70:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص71$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois71:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص72$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois72:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص73$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois73:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص74$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois74:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص75$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois75:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص76$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois76:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص77$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois77:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص78$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois78:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص79$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois79:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص80$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois80:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص81$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois81:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(pattern="عكس الالوان$", outgoing=True))
async def memes(mafia):
    reply = await mafia.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(mafia, "الرد على الوسائط المدعومة...")
    ...
    for files in (mafiasticker, meme_file):
        if files and os.path.exists(files):
            os.remove(files)
@hsshh.on(admin_cmd(outgoing=True, pattern="ص82$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois82:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص83$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois83:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص84$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois84:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص85$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois85:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص86$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois86:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص87$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois87:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص88$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois88:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص89$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois89:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص90$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois90:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص91$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois92:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص92$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois92:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص93$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois93:
        await vois.client.send_file(vois.chat_id, iqvois93 , reply_to=Ti)
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص94$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois94:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="ص95$"))
async def iqvois(vois):
    if vois.fwd_from:
        return
    Ti = await rd(vois)
    if iqvois95:
        ...
        await vois.delete()
@hsshh.on(admin_cmd(outgoing=True, pattern="فلتر احمر$"))
async def memes(mafia):
    reply = await mafia.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(mafia, "الرد على الوسائط المدعومة ...")
...
@hsshh.on(admin_cmd(outgoing=True, pattern="يمين الصوره$"))
async def memes(mafia):
    reply = await mafia.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(mafia, "الرد على الوسائط المدعومة")
...
@hsshh.on(admin_cmd(pattern="ايقاف ([\s\S]*)"))
...
hsshh.loop.create_task(digitalpicloop())
hsshh.loop.create_task(autoname_loop())
hsshh.loop.create_task(autobio_loop())
