...
FOTOSECRET = gvarstatus("OR_FOTOSECRET") or "هممم" 
...
def build_keyboard(buttons):
    ...
    return keyb
@hsshh.on(admin_cmd(pattern="هممم (\d*) ([\s\S]*)"))    
async def _(event):
...
async def all_groups_id(cat):
    ...
    return catgroups
@hsshh.on(admin_cmd(pattern="ازاله التوجيه(?: |$)(.*)"))    
async def _(event):
    try:
        await event.delete()
...
@hsshh.on(admin_cmd(pattern=f"{ALLGROUB} ?(.*)$"))    
...
async def getTranslate(text, **kwargs):
    ...
    for _ in range(10):
        try:
            ...
            await sleep(0.1)
    return result
@hsshh.iq_cmd(incoming=True, groups_only=True)
async def _(event):
    if not CHAT_FLOOD:
        return
...
@hsshh.on(admin_cmd(pattern=f"{ALLPRIVATE} ?(.*)$"))    
...
@hsshh.on(admin_cmd(pattern="كتابه وهمي(?:\s|$)([\s\S]*)"))
async def _iq(hsshh):
    iq = hsshh.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        ...
        try:
            ...
            try:
                iq = await hsshh.ban_time(iq)
            except BaseException:
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await hsshh.edit(f"**تم بدء وضع الكتابة الوهمية لـ {iq} من الثوانـي**")
    async with hsshh.client.action(hsshh.chat_id, "typing"):
        await asyncio.sleep(iq)
@hsshh.on(admin_cmd(pattern="تكرار (.*)"))    
...
@hsshh.on(admin_cmd(pattern="مؤقته (\d*) ([\s\S]*)"))    
async def selfdestruct(destroy):
    ...
    await sleep(ttl)
    await smsg.delete()
def hsshhveFile(input_file_name):
...
@hsshh.on(admin_cmd(pattern="ترحيب(?:\s|$)([\s\S]*)"))    
...
@hsshh.on(admin_cmd(pattern="مسح الترحيبات(?: |$)(.*)"))    
...
@hsshh.on(admin_cmd(pattern="ترحيباتي(?: |$)(.*)"))    
...
@hsshh.on(admin_cmd(pattern="رساله الترحيب السابقه (تشغيل|ايقاف)$"))    
async def del_welcome(event):
...
@hsshh.on(admin_cmd(pattern="موقع(?: |$)(.*)"))    
async def gps(event):
    reply_to_id = await reply_id(event)
    input_str = event.pattern_match.group(1)
    catevent = await edit_or_reply(event, "** 🇮🇶 ⦙   جاري العثـور على الموقع  … **")
    geolocator = Nominatim(user_agent="cathsshh")
...
async def ocr_hsshh(filename, overlay=False,api_key="K88942796188957", language="eng"):
    payload = {"isOverlayRequired": overlay,"apikey": api_key,"language": language}
    with open(filename, "rb") as f:
        r = requests.post("https://api.ocr.space/parse/image",files={filename: f},data=payload)
    return r.json()
@hsshh.on(admin_cmd(pattern="فيديو وهمي(?:\s|$)([\s\S]*)"))
async def _iq(hsshh):
    iq = hsshh.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await hsshh.edit(f"**تم بدء وضع فيديو وهمي لـ {iq} من الثوانـي**")
    async with hsshh.client.action(hsshh.chat_id, "record-video"):
        await asyncio.sleep(iq)
@hsshh.on(admin_cmd(pattern="ازعاج(?: |$)(.*)"))    
...
@hsshh.on(admin_cmd(pattern="الغاء الازعاج( -a)?"))    
async def echo(event):
    input_str = event.pattern_match.group(1)
    if input_str:
        lecho = get_all_echos()
        ...
        try:
            ...
            await edit_or_reply(event, "**🇮🇶 ⦙   تـم ايقاف وضـع الازعاج على الجميع بنجاح ✅**")
@hsshh.on(admin_cmd(pattern="المزعجهم( -a)?$"))    
async def echo(event):  
    input_str = event.pattern_match.group(1)
    private_chats = ""
    ...
    if not (iq or iq.isdigit()):
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await hsshh.edit(f"**تم بدء وضع صوت وهمي لـ {iq} من الثوانـي**")
    async with hsshh.client.action(hsshh.chat_id, "record-audio"):
        await asyncio.sleep(iq)
@hsshh.on(admin_cmd(pattern="تنظيف(?:\s|$)([\s\S]*)"))
...
@hsshh.on(admin_cmd(pattern="لعب وهمي(?:\s|$)([\s\S]*)"))
async def _iq(hsshh):
    iq = hsshh.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await hsshh.edit(f"**تم بدء وضع لعب وهمي لـ {iq} من الثوانـي**")
    async with hsshh.client.action(hsshh.chat_id, "game"):
        await asyncio.sleep(iq)  
@hsshh.iq_cmd(pattern="قرائه(?:\s|$)([\s\S]*)",)
async def ocriq(hsshhevent):
    iqqevent = await edit_or_reply(hsshhevent, "جاري قرائه الصوره ...")
    if not os.path.isdir(Config.TEMP_DIR):
        os.makedirs(Config.TEMP_DIR)
    lang_code = hsshhevent.pattern_match.group(1)
    downloaded_file_name = await hsshhevent.client.download_media(await hsshhevent.get_reply_message(), Config.TEMP_DIR)
    test_file = await ocr_hsshh(filename=downloaded_file_name, language=lang_code)
    try:
...
@hsshh.on(admin_cmd(pattern="اضف رد ([\s\S]*)")) 
...
@hsshh.on(admin_cmd(pattern="موقع وهمي(?:\s|$)([\s\S]*)"))
async def _iq(hsshh):
    iq = hsshh.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await hsshh.edit(f"**تم بدء وضع موقع وهمي لـ {iq} من الثوانـي**")
    async with hsshh.client.action(hsshh.chat_id, "location"):
        await asyncio.sleep(iq)
@hsshh.on(admin_cmd(pattern="جميع الردود(?: |$)(.*)"))    
...
@hsshh.on(admin_cmd(pattern="مسح رد ([\s\S]*)")) 
...
@hsshh.on(admin_cmd(pattern="مسح جميع الردود(?: |$)(.*)"))    
...
@hsshh.on(admin_cmd(pattern="تكلم(?:\s|$)([\s\S]*)"))    
async def _(event):
    input_str = event.pattern_match.group(1)
    start = datetime.now()
    reply_to_id = await reply_id(event)
...
@hsshh.on(admin_cmd(pattern="تحذير تكرار(?:\s|$)([\s\S]*)"))
async def _(event):
    input_str = event.pattern_match.group(1)
...
@hsshh.on(admin_cmd(pattern="ترجمه ([\s\S]*)"))
async def _(event):
    input_str = event.pattern_match.group(1)
    if event.reply_to_msg_id:
        previous_message = await event.get_reply_message()
...
@hsshh.on(admin_cmd(pattern=f"{FOTOSECRET}(?: |$)(.*)"))    
async def iq(event):
  if not event.is_reply:
    return await event.edit('**فضحتنه الله يفضحك دسوي رد عليه**')
  ogtah = await event.get_reply_message()
  pic = await ogtah.download_media()
  await bot.send_file('me', pic, caption=f"""**جبتلك الصوره حجي ✅**\- So : @N_B_1""")
  await event.delete()
@hsshh.on(admin_cmd(pattern="تاريخ الرساله(?: |$)(.*)"))    
async def _(event):
...
@hsshh.on(admin_cmd(pattern="جهه اتصال وهمي(?:\s|$)([\s\S]*)"))
async def _iq(hsshh):
    iq = hsshh.pattern_match.group(1)
    if not (iq or iq.isdigit()):
        iq = 100
        ...
        try:
            ...
            try:
                ...
                return await event.edit("**اكتب الامر بشكل صحيح**")
    await hsshh.edit(f"**تم بدء وضع جهه اتصال وهمي لـ {iq} من الثوانـي**")
    async with hsshh.client.action(hsshh.chat_id, "contact"):
        await asyncio.sleep(iq)  
@hsshh.on(admin_cmd(pattern="ماركدون(?:\s|$)([\s\S]*)"))    
async def _(event):
    reply_to_id = await reply_id(event)
    ...
    await event.delete()
@hsshh.on(admin_cmd(pattern="حذف(?:\s|$)([\s\S]*)"))
async def iq(cloneiq):  
    chat = await cloneiq.get_input_chat()
    msgs = []
    count = 0
    ...
    await sleep(5)
    await hi.delete()
@hsshh.on(admin_cmd(pattern="معرفات 100(?: |$)(.*)"))
async def iq(hsshh):
    mentions = hsshh.text[8:]
    chat = await hsshh.get_input_chat()
    async for x in hsshh.client.iter_participants(chat, 100):
        mentions += f" - @{x.username} ⦙ "
    await hsshh.client.send_message(hsshh.chat_id, mentions)
    await hsshh.delete()
@hsshh.on(admin_cmd(pattern="معرفات 200(?: |$)(.*)"))
async def iq(hsshh):
    mentions = hsshh.text[8:]
    chat = await hsshh.get_input_chat()
    async for x in hsshh.client.iter_participants(chat, 200):
        mentions += f" - @{x.username} ⦙ "
    await hsshh.client.send_message(hsshh.chat_id, mentions)
    await hsshh.delete()
@hsshh.on(admin_cmd(pattern="تاك 200(?: |$)(.*)"))
async def iq(hsshh):
    mentions = hsshh.text[8:]
    chat = await hsshh.get_input_chat()
    async for x in hsshh.client.iter_participants(chat, 200):
    ...
    await hsshh.client.send_message(hsshh.chat_id, mentions)
    await hsshh.delete()
@hsshh.on(admin_cmd(pattern="تاك 150(?: |$)(.*)"))
async def iq(hsshh):
    mentions = hsshh.text[8:]
    chat = await hsshh.get_input_chat()
    async for x in hsshh.client.iter_participants(chat, 150):
        mentions += f" \n🇮🇶 ⦙ ⵧ〈[{x.first_name}](tg://user?id={x.id})〉 \n"
    await hsshh.client.send_message(hsshh.chat_id, mentions)
    await hsshh.delete()
@hsshh.on(admin_cmd(pattern="تاك 100(?: |$)(.*)"))
async def iq(hsshh):
    mentions = hsshh.text[8:]
    chat = await hsshh.get_input_chat()
    async for x in hsshh.client.iter_participants(chat, 100):
    ...
    await hsshh.client.send_message(hsshh.chat_id, mentions)
    await hsshh.delete()
@hsshh.on(admin_cmd(pattern="تاك 50(?: |$)(.*)"))
async def iq(hsshh):
    mentions = hsshh.text[8:]
    chat = await hsshh.get_input_chat()
    async for x in hsshh.client.iter_participants(chat, 50):
        mentions += f" \n🇮🇶 ⦙ ⵧ〈[{x.first_name}](tg://user?id={x.id})〉 \n"
    await hsshh.client.send_message(hsshh.chat_id, mentions)
    await hsshh.delete()
@hsshh.on(admin_cmd(pattern="تاك 10(?: |$)(.*)"))
async def iq(hsshh):
    mentions = hsshh.text[8:]
    chat = await hsshh.get_input_chat()
    async for x in hsshh.client.iter_participants(chat, 10):
        mentions += f" \n 🇮🇶 ⦙ ⵧ〈[{x.first_name}](tg://user?id={x.id})〉 \n"
    await hsshh.client.send_message(hsshh.chat_id, mentions)
    await hsshh.delete()
@hsshh.on(admin_cmd(pattern="احسب ([\s\S]*)"))    
...
@hsshh.iq_cmd(pattern="(ازاله الخلفيه بالملصق|ازاله الخلفيه)(?:\s|$)([\s\S]*)",)
async def remove_iq(event):
    ...
    if event.reply_to_msg_id and not input_str:
        ...
        try:
            ...
            response = hsshhveFile(file_name)
            os.remove(file_name)
    elif input_str:
        catevent = await edit_or_reply(event, "إزالة خلفية هذه الوسائط")
        response = hsshhveURL(input_str)
    else:
    ...
    remove_bg_image = "hsshh.png"
    if "image" in contentType:
        with open("hsshh.png", "wb") as removed_bg_file:
            removed_bg_file.write(response.content)
    else:
        await edit_delete(catevent, f"`{response.content.decode('UTF-8')}`", 5)
        return
    if cmd == "ازاله الخلفيه بالملصق":
        file = convert_tosticker(remove_bg_image, filename="hsshh.webp")
    ...
    await catevent.delete()
@hsshh.on(admin_cmd(pattern="ابلاغ الادمنيه(?: |$)(.*)"))    
async def iq(event):
...
async def on_new_message(event):
    ...
    for snip in snips:
        ...
        if re.search(pattern, name, flags=re.IGNORECASE):
            ...
            break
@hsshh.on(admin_cmd(pattern="خط ملصق ?(?:(.*?) ?; )?([\s\S]*)"))    
async def sticklet(event):
    ...
    image_stream.name = "hsshh.webp"
    image.save(image_stream, "WebP")
    image_stream.seek(0)
    await event.client.send_file(        event.chat_id,        image_stream,        caption="hsshh's Sticklet",        reply_to=reply_to_id,    )
    try:
        os.remove(FONT_FILE)
    except BaseException:
        pass
@hsshh.on(admin_cmd(pattern="ضفدع(?:\s|$)([\s\S]*)"))    
...
@hsshh.on(admin_cmd(pattern="منع(?:\s|$)([\s\S]*)"))    
async def _(event):
    text = event.pattern_match.group(1)
...
@hsshh.on(admin_cmd(pattern="الغاء منع(?:\s|$)([\s\S]*)"))    
async def _(event):
    text = event.pattern_match.group(1)
...
@hsshh.on(admin_cmd(pattern="قائمه المنع$"))    
async def _(event):
...
@hsshh.on(admin_cmd(pattern="مسح(\s*| \d+)$"))
async def iq(msg1):
    ...
    if iq_src:
        ...
        await msg1.delete()
@hsshh.on(admin_cmd(pattern="تاك بالكلام ([\s\S]*)"))    
async def iq(event):
...
@hsshh.on(admin_cmd(pattern="لافته(?:\s|$)([\s\S]*)"))    
...
@hsshh.on(admin_cmd(pattern="نسخ(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
...
@hsshh.on(admin_cmd(pattern="غمق(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
    if nshkh.reply_to_msg_id:
        ...
        await nshkh.edit("**🇮🇶 ⦙   قم  برد على الرساله ** ")
@hsshh.on(admin_cmd(pattern="ينسخ(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
    if nshkh.reply_to_msg_id:
        ...
        await nshkh.edit("**🇮🇶 ⦙   قم  برد على الرساله ** ")
@hsshh.on(admin_cmd(pattern="خط سفلي(?: |$)(.*)"))
async def iq(nshkh):
    if nshkh.fwd_from:
        return
    if nshkh.reply_to_msg_id:
